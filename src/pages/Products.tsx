            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium bg-white text-gray-700 hover:bg-gray-100 ${selectedCategory === 'All Products'
                ...
                {subcategories.map((sub) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium bg-white text-gray-700 hover:bg-gray-100 ${selectedCategory === sub
                        ? 'border-b-4 border-yellow-400'
                        : ''
                      }`}
                  >
            ...
            {filteredProducts.map((product) => (
              <div key={product.id} className="bg-white rounded-lg overflow-hidden group">
                <img
                  ...
                  className="w-full h-[309px] object-contain border-blue-50 border-2 rounded-lg bg-gray-50"
                />
                <div className="p-6">

    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border-blue-100 border-2 aspect-square w-full max-w-[480px] mx-auto lg:ml-3 lg:mx-0 flex items-center justify-center">
            <img
              src={product.image}
          ...
          {isModalOpen && (
            ...
            >
              {/* Modal Content */}
              <div
                className="relative w-full h-full max-w-4xl max-h-[90vh] bg-white rounded-lg shadow-2xl overflow-hidden"
          ...
          {/* <div className="space-y-6">
            <div>
              <h2 className="text-4xl font-normal mb-4" style={{ color: '#309ed9' }}>
                {product.product_name}
              </h2>
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-4xl font-normal mb-4 border-b-4 border-yellow-400 inline-block pb-2" style={{ color: '#309ed9' }}>
                {product.product_name}
              </h2>
        ...
        <div className={`grid grid-cols-1 gap-8 ${relatedProducts.length > 0 ? 'lg:grid-cols-2' : ''}`}>
          {/* Contact Section */}
          ...
          {/* Related Products - Only render if there are related products */}

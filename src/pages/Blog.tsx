      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
              <article key={post.id} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-200 border border-gray-200">
                <div className="bg-white h-48 flex items-center justify-center">
                  {/* <p className="text-gray-500">Blog Image</p> */}
                  <img  src='/eversure-logo.jpg' alt='eversure logo'/>
                </div>
                <div className="p-6">

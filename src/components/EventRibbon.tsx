...
//   return (
//     <div className="">
//       {/* Red warning div - shows when event is exactly 2 days away */}
//       {warningInfo.showWarning && (
//         <div className="bg-blue-100 text-blue-800 p-4 flex items-center space-x-2">
...
//       {/* Regular info when event is not within warning period */}
//       {/* {!warningInfo.showWarning && (
//         <div className="bg-blue-100 text-blue-800 p-4">
//           <h4 className="font-semibold">Next Event</h4>
//           <p>
//             {warningInfo.event.title} is in {warningInfo.daysDifference} days
//           </p>
//         </div>
//       )} */}
//     </div>
...
//     showWarning: daysDifference <= 2  // Changed to exactly 2 days
//   };
// };

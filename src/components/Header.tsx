...
const Header = () => {
  ...
  // Function to close search and reset state
  const closeSearch = () => {
    setShowSearch(false);
    setSearchTerm('');
    setFilteredProducts([]);
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative">
              ...
              {showSearch && (
                <div ref={searchRef} className="absolute right-0 top-12 z-50 bg-white border border-gray-200 rounded-lg shadow-lg w-96">
